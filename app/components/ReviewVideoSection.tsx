        ...
        <div className="bg-white rounded-xl shadow-lg relative flex items-center justify-center overflow-hidden">
          {teamLeaderVideoUrl ? (
            <iframe
              width="100%"
              height="100%"
              src={`https://www.youtube.com/embed/${teamLeaderVideoUrl.match(/(?:https?:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/watch\?v=([^\s&]+)|youtu\.be\/([^\s&]+)|youtube\.com\/embed\/([^\s&]+)/)?.[1] || teamLeaderVideoUrl.match(/(?:https?:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/watch\?v=([^\s&]+)|youtu\.be\/([^\s&]+)|youtube\.com\/embed\/([^\s&]+)/)?.[2] || teamLeaderVideoUrl.match(/(?:https?:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/watch\?v=([^\s&]+)|youtu\.be\/([^\s&]+)|youtube\.com\/embed\/([^\s&]+)/)?.[3]}`}
