...
router.put('/', auth, async (req, res) => {
  try {
    const { headerPromoText, navbarLogoUrl, navbarLogoText, isLogoTextVisible, heroImageUrl, heroMainText, heroButtonText, heroButtonUrl, heroTextColor, heroOverlayColor, heroButtonBgColor, heroButtonTextColor, heroHeadingFontSize, reviewVideoUrl, reviewVideoTitle, reviewVideoDescription, reviewVideoPlaceholderImage, teamLeaderImage, teamLeaderTitle, teamLeaderSubtitle, teamLeaderAvatar, teamLeaderAuthor, teamLeaderRole, teamLeaderRating, teamLeaderText, teamLeaderVideoUrl, footerAboutText, footerSocialLinks, footerCopyrightText, footerPaymentImages, metaTitle, metaLogoUrl, productsPageHeading, productsPageSubheading, brandsPageHeading, brandsPageSubheading, categoriesPageHeading, categoriesPageSubheading, blogPageHeading, blogPageSubheading, paymentImageUrl } = req.body;

    let setting = await Setting.findOne();
    if (!setting) {
      setting = new Setting({ headerPromoText, navbarLogoUrl, navbarLogoText, isLogoTextVisible, heroImageUrl, heroMainText, heroButtonText, heroButtonUrl, heroTextColor, heroOverlayColor, heroButtonBgColor, heroButtonTextColor, heroHeadingFontSize, reviewVideoUrl, reviewVideoTitle, reviewVideoDescription, reviewVideoPlaceholderImage, teamLeaderImage, teamLeaderTitle, teamLeaderSubtitle, teamLeaderAvatar, teamLeaderAuthor, teamLeaderRole, teamLeaderRating, teamLeaderText, teamLeaderVideoUrl, footerAboutText, footerSocialLinks, footerCopyrightText, footerPaymentImages, metaTitle, metaLogoUrl, productsPageHeading, productsPageSubheading, brandsPageHeading, brandsPageSubheading, categoriesPageHeading, categoriesPageSubheading, blogPageHeading, blogPageSubheading, paymentImageUrl });
    } else {
      ...
      setting.teamLeaderVideoUrl = teamLeaderVideoUrl; // Add this line
      ...
      setting.paymentImageUrl = paymentImageUrl; // Add this line
    }
